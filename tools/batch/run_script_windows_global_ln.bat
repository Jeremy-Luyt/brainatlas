:: -f fixed_image::<<global_registration.exe>> config
...
..\binary\win64_bin\zmj\global_registration.exe -f E:\fmost_demo\examples\target_ln\fa\ -m E:\ln_data\downstrip\cutoff7_radius6_preprocess.v3draw  -p a+f+n -o E:\ln_data\global_result\ -d 0 -l 0+0+0 -s E:\ln_data\marker\cutoff7_radius6_preprocess.marker -t E:\ln_data\marker\new2.marker
